...
if __name__ == '__main__':
    ...
    parser.add_argument('--bot_name', type=str, default='autobot07')
    parser.add_argument('--container_name', type=str, default='dts-segmentation-node')
    args = parser.parse_args()
    client = docker.from_env()

    arguments = {'image': f'docker.io/duckietown/dt-segmentation-node:{args.branch}-amd64',
