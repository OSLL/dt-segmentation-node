...
class Segmentation:
    def __init__(self, model_dir="/code/catkin_ws/src/dt-ros-commons/packages/segmentation_node/model/",
    ...
    def observation(self, obs):
        ...
        image = mask_yellow + mask_red + mask_white+mask_green
        image = image.astype(np.uint8)
        return image


class SegmentationNode(DTROS):
...
if __name__ == "__main__":
    node = SegmentationNode("segmentation_node")
    rospy.spin()